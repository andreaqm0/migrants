<script lang="ts">
  import AddEmailRow from "./AddEmailRow.svelte";
...
<div class="card bg-base-100 shadow col-span-2 xl:col-span-1">
  <div class="card-body">
    <div class="flex justify-between items-center">
      <h3 class="text-xl text-slate-600 font-semibold">Correos Electrónicos</h3>
      <button
      ...
      <table class="table">
        ...
        <tbody>
          <tr class:hidden={!formActive}>
            <AddEmailRow bind:formActive />
          </tr>
          {#each emails as e, index}
            <tr>
              <th>{index + 1}</th>
              <td>{e.description || ""}</td>
              <td>{e.email}</td>
              <td>
                ...
                >
                  ...
                  <label for={"del-email-" + e.id} class="btn btn-xs btn-ghost">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
