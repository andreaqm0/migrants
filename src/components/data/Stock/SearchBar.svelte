<script lang="ts">
  ...
  import { getStaysFilteringParams, getStockFilteringParams } from "@/services/utils";
  ...
  function clear() {
    const url = new URL("/stock", window.location.origin);
    window.location.assign(url.toString());
  }

  onMount(() => {
    const params = getStockFilteringParams();
